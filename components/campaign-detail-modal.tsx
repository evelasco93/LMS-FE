        ...
        <div className="space-y-4">
          <div className="flex gap-6 h-[65vh]">
            ...
            <div className="flex-1 min-w-0 flex flex-col min-h-0">
              {/* Breadcrumb strip */}
              <div className="mb-2 flex shrink-0 items-center gap-1.5 border-b border-[--color-border] pb-2.5 text-[11px] text-[--color-text-muted]">
                            ...
                            >
                              <span className="flex items-center gap-2 font-semibold text-[--color-text-strong]">
                                ...
                                <span className="text-xs font-normal text-[--color-text-muted]">
                                  ...
                                  {campaignChangeHistory.length !== 1
                                    ? "s"
                                    : ""}
                                  )
                                </span>
                                ...
                                >
                                  ...
                                  <AnimatePresence initial={false}>
                                    {ipqsOpen && (
                                      ...
                                      >
                                        <div className="mt-3 pt-3 border-t border-[--color-border] space-y-3">
                                          {/* Reject-on-failure — hidden when plugin is disabled */}
                                          {!ipqsGloballyDisabled &&
                                            ipqsConfig.enabled && (
                                              <div className="flex items-center gap-1.5 text-xs">
